...
export default function Super8Dashboard({ config, players, openMatchGlobalId }: Super8DashboardProps) {
  ...
  return (
    <div className="flex-1 flex flex-col mt-4">
      ...
      {/* Sync Warning Banner */}
      {syncWarning && (
        <div className="mx-5 mt-2 px-4 py-2 bg-amber-500/10 border border-amber-500/30 rounded-lg text-amber-600 dark:text-amber-400 text-sm font-medium animate-pulse">
          ⚡ {syncWarning}
        </div>
      )}
